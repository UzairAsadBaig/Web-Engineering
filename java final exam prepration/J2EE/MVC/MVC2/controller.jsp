...
<%-- importing required packages. package MyPack contains JavaBeans --%> 
...
// Remember that “action” is the name of buttons as well it is used in hyperlinks in making of query string 
...
// storing personList(contains PersonInfo objects) 
